...
double tempsQualif1 = 100;//1080/60 = 18 min = 1080
double tempsQualif2 = 100;//15 min = 900
double tempsQualif3 = 100;//12 min = 720
...
void genereRecapQualifFile()
{
	...
	if(fichier != NULL){
		...
		fprintf(fichier,"\n Le gagant est la voiture numéro %2d with avec un temps de %9f s\n",tempo.nom, tempo.topCircuit);
		fclose(fichier);
	}
	else{
